...
import com.example.LNDWA.adapters.CardAdapter;
import com.example.LNDWA.adapters.CardAdapter2;
...
import com.example.LNDWA.views.edit.EditPosition;
import com.example.LNDWA.views.fragment.AboutDialogFragment;
import com.example.LNDWA.views.fragment.SavePresetFragment;
                    ...
                    public void onClick(final View view) {
                        ...
                        if (ChooseChars.this.rounds != 0) {
                            ...
                            if (ChooseChars.this.roundcardlist == null) {
                                ...
                                intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                                Bundle mBundle = new Bundle();
                                Collections.sort(ChooseChars.this.roundcardlist, new Comparator<Karte>() {
                                    public int compare(Karte s1, Karte s2) {
        ...
        switch (id) {
            ...
            case 2:
                if (!this.gameset.getPresets().isEmpty()) {
                    builder.setItems(this.getPresetArray(), new DialogInterface.OnClickListener() {
                        @Override

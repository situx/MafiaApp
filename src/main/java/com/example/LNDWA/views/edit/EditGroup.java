    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        editGroupName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                EditGroup.this.group.setGroupname(((EditText) view).getText().toString());
            }
        });
        ...
        editGroupIdentifier.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(final View view) {
                EditGroup.this.group.setGroupIdentifier(((EditText) view).getText().toString());
            }
        });
        ...
        editGroupDescription.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(final View view) {
                EditGroup.this.group.setGroupdescription(((EditText) view).getText().toString());
            }
        });
        ...
        winsgameCB.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override

...
import com.github.situx.mafiaapp.util.parser.EventParse;
...
public class GameSet implements Parcelable, GameElements,Comparable<GameSet> {
    ...
    public GameSet(final File file) throws IOException, SAXException, ParserConfigurationException {
        ...
        Collections.sort(this.cards, (s1, s2) -> s1.getName().compareTo(s2.getName()));
        this.items = new LinkedList<>();
        ...
        Collections.sort(this.events, (s1, s2) -> s1.getTitle().compareTo(s2.getTitle()));

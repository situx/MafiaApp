...
import com.github.situx.mafiaapp.views.edit.EditAbility;
            ...
            if(holder.textView==null){
                ...
                if(considerFromUntil && current.checkFromUntil(this.round) || !considerFromUntil){
                    if(this.layoutid==R.layout.ability){
                        ...
                        holder.button.setOnClickListener(view1 -> {
                            ...
                            TextView textView=(TextView) view1.findViewById(R.id.charViewRoundAbility);
                            textView.setText(this.abilityList.get(button.getId()).getDescription()+": "+AbilityAdapter.this.abilityList.get(button.getId()).currentamount +"x");
                        });
                    }
                    if(this.layoutid==R.layout.item_ability){
                        ...
                        holder.button.setOnClickListener(view12 -> {
                        ...
                        holder.button2.setOnClickListener(view13 -> {
                            AbilityAdapter.this.abilityList.remove(view13.getId());

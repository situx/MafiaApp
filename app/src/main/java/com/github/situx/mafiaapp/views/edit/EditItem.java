...
public class EditItem extends ViewUtils {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        editItemName.setOnClickListener(view -> EditItem.this.item.setName(((EditText)view).getText().toString()));
        ...
        editItemDescription.setOnClickListener(view -> EditItem.this.item.setDescription(((EditText)view).getText().toString()));
        ...
        editItemProbability.setOnClickListener(view -> EditItem.this.item.setProbability(Integer.valueOf(((EditText)view).getText().toString())));
        ...
        permanentButton.setOnCheckedChangeListener((compoundButton, b) -> {
            permanentButton.setChecked(b);
            if(b)
                EditItem.this.item.setRound(0);
        });
        oneTimeRadioButton.setOnCheckedChangeListener((compoundButton, b) -> {

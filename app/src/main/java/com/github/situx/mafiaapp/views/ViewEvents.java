...
import com.github.situx.mafiaapp.adapters.EventAdapter;
import com.github.situx.mafiaapp.cards.Event;
import com.github.situx.mafiaapp.views.edit.EditEvent;
...
public class ViewEvents extends ViewUtils {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        Collections.sort(this.eventlist, (s1, s2) -> s1.getTitle().compareTo(s2.getTitle()));

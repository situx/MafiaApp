...
import com.github.situx.mafiaapp.adapters.DialogAbilityAdapter;
import com.github.situx.mafiaapp.adapters.DialogCardAdapter;
...
import com.github.situx.mafiaapp.views.fragment.GameLogFragment;
...
public class Round2 extends ViewUtils implements
        ...
        switch (id) {
            ...
            case 2:
                builder.setTitle(R.string.pick_player)
                        .setAdapter(new PlayerListAdapter(this, this.playerarray, 2), (dialogInterface, i) -> Round2.this.currentfragment.setPlayerDialog(i))
            ...
            case 3:
                ...
                AlertDialog dialog = builder.setTitle(this.getResources().getString(R.string.chooseextracards) + " (" + this.currentfragment.getExtracardamount() + ")")
                        ...
                        .setNegativeButton(R.string.cancel, (dialog113, id112) -> Round2.this.finish()).setAdapter(adapter, null).create();
                dialog.setButton(Dialog.BUTTON_POSITIVE, Round2.this.getResources().getString(R.string.ok), (dialogInterface, i) -> {
            ...
            case 4:
                builder.setTitle(this.getResources().getString(R.string.extracards))
                        .setNegativeButton(R.string.cancel, (dialog1, id13) -> {
            ...
            case 5:
                ...
                builder.setTitle(this.getResources().getString(R.string.event) + " " + message.substring(0, message.indexOf('\n')))
                        .setPositiveButton(R.string.ok, (dialog13, id15) -> {
            ...
            case 6:
                builder.setTitle(this.getResources().getString(R.string.kill))
                        .setPositiveButton(R.string.ok, (dialog12, id14) -> Round2.this.currentfragment.killCharacter(Round2.this.currentfragment.getLastcheckedrelId())).setNegativeButton(R.string.cancel, new DialogInterface.OnClickListener() {
                    @Override
            ...
            case 7:
                builder.setTitle(this.getResources().getString(R.string.switchchar))
                        .setNegativeButton(R.string.cancel, (dialog14, id16) -> {
            ...
            case 8:
                builder.setTitle(this.getResources().getString(R.string.deadcards))
                        .setNegativeButton(R.string.cancel, (dialog15, id17) -> {
            ...
            case 9:
                builder.setTitle(this.getResources().getString(R.string.chooseability))
                        .setNegativeButton(R.string.cancel, (dialog16, id18) -> {
            ...
            case 10:
                ...
                builder.setTitle(currentcard.getName() + "(" + currentcard.getGroup() + ")")
                        .setPositiveButton(R.string.ok, (dialog19, id111) -> {
            ...
            case 11:
                builder.setTitle(this.getResources().getString(R.string.deadcards))
                        .setNegativeButton(R.string.cancel, (dialog18, id110) -> {
            ...
            case 12:
                builder.setTitle(this.getResources().getString(R.string.choosegroup))
                        .setNegativeButton(R.string.cancel, (dialog17, id19) -> {

                        }).setAdapter(new GroupAdapter(this, Round2.this.currentfragment.getGroupdialogarray()), (dialogInterface, i) -> Round2.this.currentfragment.setGroup(i));
                break;
            case 13:
                ...
                builder.setIcon(this.getResources().getDrawable(R.drawable.title))
                        .setTitle(this.getResources().getString(R.string.savegamedialog)
                        ).setPositiveButton(this.getResources().getString(R.string.ok), (dialog110, buttonid) -> {
                            ...
                            toast.show();
                        }).setNegativeButton(this.getResources().getString(R.string.cancel), (dialogInterface, i) -> dialogInterface.cancel()).setView(input);
                break;
            case 14:
                builder.setItems(this.currentfragment.getGameLog(),null)
                        .setCancelable(true)
                        .setTitle(this.getResources().getString(R.string.showgamelog))
                        .setPositiveButton(this.getResources().getString(R.string.ok), (dialog111, buttonid) -> dialog111.cancel());
                break;
            case 15:
                ...
                builder.setView(view)
                        ...
                        .setPositiveButton(this.getResources().getString(R.string.ok), (dialog112, buttonid) -> dialog112.cancel());
                break;
            default:
        }
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        ...
        menu.getItem(9).setOnMenuItemClickListener(menuItem -> {
        ...
        menu.getItem(10).setOnMenuItemClickListener(menuItem -> {
            Round2.this.finish();
            return true;
        });
        menu.getItem(11).setOnMenuItemClickListener(menuItem -> {
        ...
        menu.getItem(12).setOnMenuItemClickListener(menuItem -> {

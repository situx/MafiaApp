...
public class EditAbility extends ViewUtils {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        abilityDescription.setOnFocusChangeListener((view, b) -> ability.setDescription(((EditText)view).getText().toString()));
        ...
        abilityAmount.setOnFocusChangeListener((view, b) -> ability.setOriginalamount(Integer.valueOf(((EditText) view).getText().toString())));
        CheckBox checkBox=(CheckBox)this.findViewById(R.id.editAbilityActiveCB);
        checkBox.setChecked(ability.getActive());
        checkBox.setOnCheckedChangeListener((compoundButton, b) -> EditAbility.this.ability.setActive(b));
        CheckBox checkBox2=(CheckBox)this.findViewById(R.id.editAbilityMustUseCB);
        checkBox2.setChecked(ability.getMustuse());
        checkBox2.setOnCheckedChangeListener((compoundButton, b) -> EditAbility.this.ability.setMustuse(b));
        CheckBox onDeadCheckBox=(CheckBox)this.findViewById(R.id.editAbilityOnDead);
        onDeadCheckBox.setChecked(ability.getOndead());
        onDeadCheckBox.setOnCheckedChangeListener((compoundButton, b) -> EditAbility.this.ability.setOndead(b));
        ...
        killingcheckbox.setOnCheckedChangeListener((compoundButton, b) -> EditAbility.this.ability.setKilling(b));
        CheckBox selfusecheckbox=(CheckBox)this.findViewById(R.id.editAbilitySelfUse);
        selfusecheckbox.setChecked(ability.getSelf());
        selfusecheckbox.setOnCheckedChangeListener((compoundButton, b) -> EditAbility.this.ability.setSelf(b));
        ...
        counterKillingCheckbox.setOnCheckedChangeListener((compoundButton, b) -> EditAbility.this.ability.setCounterKilling(b));
        ...
        switchCharCheckbox.setOnCheckedChangeListener((compoundButton, b) -> EditAbility.this.ability.setSwitchchar(b));
        ...
        availableFromText.setOnFocusChangeListener((view, b) -> {
            if(!b)
        ...
        availableUntilText.setOnFocusChangeListener((view, b) -> {
            if(!b)
        ...
        probabilityText.setOnFocusChangeListener((view, b) -> {
            if (!b)
        ...
        saveAbilityButton.setOnClickListener(view -> EditAbility.this.finish());
        this.abilityImageView=(ImageView) this.findViewById(R.id.editAbilityImgView);
        this.abilityImageView.setOnClickListener(view -> {
        ...
        abilityConcernsEditText.setOnFocusChangeListener((view, b) -> {
            if (!b)
        ...
        abilityDurationEditText.setOnFocusChangeListener((view, b) -> {
            if(!b)
        ...
        abilityDelayEditText.setOnFocusChangeListener((view, b) -> {
            if(!b)
        ...
        abilitySwitchNewCharEditText.setOnFocusChangeListener((view, b) -> {
            if(!b)

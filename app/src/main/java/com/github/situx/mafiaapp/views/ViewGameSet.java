...
import com.github.situx.mafiaapp.adapters.GameSetEditAdapter;
...
public class ViewGameSet extends ViewUtils {
     ...
     */
    private View.OnClickListener addGameSet= view -> {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        if(!turn){
            ...
            Collections.sort(this.gamesets, (s1, s2) -> s1.getTitle().compareTo(s2.getTitle()));
